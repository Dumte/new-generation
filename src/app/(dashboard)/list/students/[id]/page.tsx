        ...
        <div className="flex flex-col gap-4 lg:flex-row">
          ...
          <div className="bg-newGenerationSky flex flex-1 py-6 px-4 rounded-md gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <h1 className="text-xl font-semibold">Alice Nwigure</h1>
      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="rounded-md p-4 bg-white">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            <Link className="p-3 rounded-md bg-newGenerationSky" href="/">Student&apos;s Lessons</Link>
            <Link className="p-3 rounded-md bg-newGenerationPurpleLight" href="/">Student&apos;s Teachers</Link>
            <Link className="p-3 rounded-md bg-newGenerationPurple" href="/">Student&apos;s Result</Link>
            <Link className="p-3 rounded-md bg-newGenerationSky" href="/">Student&apos;s Assignments</Link>
